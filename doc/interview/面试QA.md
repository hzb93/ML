...
主要做了动态评级模型，增换购模型，门店分配模型。动态评级是指对用户被跟进过程中各个状态进行打分评级，评估用户的到店/试驾/下订的意愿度。从客户留下电话号码，到电销顾问进行电话跟进过程中，讲客户的状态
分为未分配，未跟进，跟进中，跟进逾期，长期未跟进，战败等。拿用户的留资信息，顾问的跟进情况和用户在app等私域行为数据来预测客户是否会买车。
...
Q3：您提到了熟悉主流的机器学习和深度学习框架，如TensorFlow。能否具体描述一下您在使用TensorFlow时，如何针对特定问题选择和优化模型？
